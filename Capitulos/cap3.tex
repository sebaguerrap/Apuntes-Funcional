...
\begin{proof}
    ...
    \[D_N(0)=\frac{2N+1}{2\pi}\quad \text{Para }x\neq 0\]
...
\begin{fnote}
    ...
    Es difícil demostrar directamente que $S_ f(x)\to f(x)$ ($D_N(x)$ cambia de signo y oscila muy rápidamente). 
\end{fnote}
...
\[\ mplies S_n f \equiv 0\quad \forall n\in\Z\implies \sigma_N f\equiv 0\]
